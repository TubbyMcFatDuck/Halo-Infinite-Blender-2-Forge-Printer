...
def process_execute(item_List, path, start_index, position_only, low_performance):
    Keymanager.process_objects(item_List, path, start_index=start_index, position_only=position_only, low_performance=low_performance)
    return
...
process_execute(item_List, path, start_index, position_only, low_performance=0.01)
